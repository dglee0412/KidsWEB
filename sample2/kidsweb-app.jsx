...
function KidsApp({ tone, fontSize, mascotOn, voiceShow, timeOfDay, splashKey }) {
  ...
  if (route.screen === 'home') {
    content = <HomeScreen tone={tone} fontSize={fontSize} mascotOn={mascotOn} onPick={pickCategory} stars={stars} timeOfDay={timeOfDay} onSettings={() => setRoute({ screen: 'settings' })} />;
